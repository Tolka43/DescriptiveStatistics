...
```
    ...
    <>:1: SyntaxWarning: invalid escape sequence '\p'
    C:\Users\agata\AppData\Local\Temp\ipykernel_29584\1208722109.py:1: SyntaxWarning: invalid escape sequence '\p'
      df_pokemon = pd.read_csv("data\pokemon.csv")
...
#no because we can see only one variable
```
...
```python
### Your code here
print("normal distribution looks like a bell and is symmetric, additionally mean and median are identical")
print("whereas skewed distribution is not symmmetrical and in contrast to normal distribution mean is different than median")
```

    normal distribution looks like a bell and is symmetric, additionally mean and median are identical
    whereas skewed distribution is not symmmetrical and in contrast to normal distribution mean is different than median
...
```python
### Your code here
print("data without outliers is sticked together whereas with outliers it means that its not one all are pretty close together but few points are in a different part of graph")
```

    data without outliers is sticked together whereas with outliers it means that its not one all are pretty close together but few points are in a different part of graph
...
### Your code here
#mean is larger
print("mean is larger than median in right-skewed distribution")
```

    mean is larger than median in right-skewed distribution
...
```python
### Check-in
plt.scatter(df_pokemon['Attack'], df_pokemon['Speed'])
```




    <matplotlib.collections.PathCollection at 0x1c8f95c11d0>




    
![png](Exercise5_files/Exercise5_60_1.png)
