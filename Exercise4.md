...
![png](Exercise4_files/Exercise4_31_0.png)
...
![png](Exercise4_files/Exercise4_35_0.png)
...
def check_rules(df):
    rules = {
        ...
        "Price > 0": df["Price"] > 0,
        "ShelveLoc in ['Bad', 'Good', 'Medium']": df["ShelveLoc"].isin(['Bad', 'Good', 'Medium']),
        "Age > 0": df["Age"] > 0,
...
```
    ...
    Population >= 0: True
    Price > 0: True
    ShelveLoc in ['Bad', 'Good', 'Medium']: True
    Age > 0: True
    Education >= 0: True
...
```
    ...
    ShelveLoc in ['Bad', 'Good', 'Medium']: 0 violations
    Age > 0: 0 violations
...
# Combine violations into a DataFrame
violated_df = pd.DataFrame(violations)
violated_rows = carseats[violated_df["Income > 0"]]
print(violated_rows)
```
...
![png](Exercise4_files/Exercise4_98_0.png)
...
![png](Exercise4_files/Exercise4_99_1.png)
...
![png](Exercise4_files/Exercise4_100_1.png)
...
# Fill boolean column with the most common value (mode)
carseats['Urban'] = carseats['Urban'].fillna(carseats['Urban'].mode()[0])
